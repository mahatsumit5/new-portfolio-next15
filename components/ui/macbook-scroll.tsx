  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="text-transparent  bg-clip-text bg-gradient-to-r from-primary to-secondary text-5xl font-bold mb-20 text-center [text-shadow:0_0_rgba(0,0,0,0.1)]"
      >
        {title || (
          <span>
